...
internal class CartSeekServiceTest {
    ...
    fun setUp() {
        ...
        whenever(cartRepository
            .findFirstByGameNameAndSystemNameAndSystemIsEmulatedAndRegionAndVersionAndRemovedOnIsNull(validGameName, validSystemName, validIsEmulated, validRegion, validVersion)
        ...
        whenever(cartRepository
            .findFirstByGameNameAndSystemNameAndSystemIsEmulatedAndRegionAndVersionAndRemovedOnIsNull(invalidGameName, invalidSystemName, invalidIsEmulated, invalidRegion, invalidVersion)
        ).thenReturn(null)
    }
